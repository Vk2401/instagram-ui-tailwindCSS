...
Instagram UI design TailwindCSS
...
instagram's user interface (UI) features a clean, simple design. The home screen .

## Demo🚀

<a target="_blank" href="https://vk2401.github.io/instagram-ui-tailwindCSS/">Live Link</a>
...
1. Clone the repository to your local machine:
   ...
   ```bash
   git clone https://vk2401.github.io/instagram-ui-tailwindCSS/
